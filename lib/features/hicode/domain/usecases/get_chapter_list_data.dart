...
class GetChapterListData {
  ...
  Future<(String title, String description, String iconPath, List<HiCodeChapter> chapters, String finalPracticeStatus, int finalPracticeQuestionCount)> call(String materialId) {
