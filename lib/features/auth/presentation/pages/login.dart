...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    super.initState();
    // Panggil event untuk memuat data "Remember Me"
    context.read<LoginBloc>().add(const LoadRememberMeData());
  }
  ...
  Widget build(BuildContext context) {
    return BlocListener<LoginBloc, LoginState>(
      listener: (context, state) {
        ...
        // Listener untuk mengisi form saat data "Remember Me" selesai dimuat
        if (state is LoginInitial && state.rememberMe) {
                                              ...
                                              return SizedBox(
                                                ...
                                                child: ElevatedButton(
                                                  ...
                                                  onPressed: state is LoginLoading ? null : () {
                                                    ...
                                                    context.read<LoginBloc>().add(LoginWithEmail(email, pass, _rememberMe));
                                                  },
